...
(function (blocks, i18n, element, editor, components) {
    ...
    registerBlockType('bk-block/paypal-donation-block', {
        title: __('Paypal Donation Bloack'),
        ...
        attributes: {
            ...
            shortcode_content: {
                type: "string",
                source: "text",
                default: "[paypal_donation_block email='" + shortcode_obj.email + "' amount='" + shortcode_obj.amount + "' currency='" + shortcode_obj.currency + "' size='" + shortcode_obj.size + "' purpose='" + shortcode_obj.purpose + "' mode='" + shortcode_obj.mode + "']"
            },
            selectnamecontrol: {
                type: 'string',
                default: ''
